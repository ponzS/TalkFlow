<template>
        ...
        <ion-toolbar>
          <ion-buttons slot="start">
            <ion-back-button text="" color="dark" @click="router.go(-1)"></ion-back-button>
          </ion-buttons>
      ...
      <ion-content class="ion-padding">
        ...
        <div color="dark"  class="image-select-btn" @click="selectImages" :disabled="isPosting">
  ...
  IonTextarea, IonIcon, IonBackButton, IonLoading, toastController 
} from '@ionic/vue';
    ...
    if (input.files) {
      ...
      for (const file of files) {
        try {
          ...
          console.error(t('failedCompressImage'), error);
  ...
  const handlePost = async () => {
    ...
    try {
      await withTimeout(postMoment(), 10000); // 10秒超时
      ...
      console.error(t('momentPublishFailed'), error);
