...
declare global {
  ...
  const useVoiceRoom: typeof import('./composables/useVoiceCall')['useVoiceRoom']
...
declare global {
  ...
  // @ts-ignore
  export type { KeyPair, LocalChatMessage, NetworkChatMessage, Buddy, ReceivedRequest, MessageType, MessageStatus, ChatPreview } from './composables/TalkFlowCore'
