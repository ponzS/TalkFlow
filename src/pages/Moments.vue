  ...
  <ion-page>
    <ion-header collapse="fade" class="ion-no-border" style="--background: transparent !important;">
      <ion-toolbar>
        ...
        <ion-title @click="goToMyNode">Link</ion-title>
    ...
    <ion-content :fullscreen="true">
      <img @click="goToMyNode" ref="headerImg" :data-src="getAvatar(currentUserPub!)" style="width: 100%; height: 300px; object-fit: cover;" />

   

      <ion-header collapse="condense">
        <ion-toolbar>
          <ion-title size="large" @click="goToMyNode">Link</ion-title>
          <ion-buttons :collapse="true" slot="end">
            <ion-button slot="end" @click="router.push('/PostMoment')">
              <ion-icon slot="end" color="dark" :icon="createOutline"></ion-icon>
            </ion-button>
