<template>
   ...
   <!-- <ion-buttons slot="end">
    ...
    <ion-content :fullscreen="true" class="cosmic-content">
      ...
      <div class="card-grid">
        ...
        <!-- <div class="cosmic-card" @click="goToVoiceRoom">
          <ion-icon :icon="pulseOutline" class="cosmic-icon" />
          <span class="cosmic-label">D-VoiceRoom</span>
        </div> -->
        <div class="cosmic-card" @click="goToAI">
          <ion-icon :icon="pulseOutline" class="cosmic-icon" />
          <span class="cosmic-label">Soul for D-AI</span>
        </div>
        <div class="cosmic-card" @click="goToAIChat">
          <ion-icon :icon="pulseOutline" class="cosmic-icon" />
          <span class="cosmic-label">D-AI-Chat-MCP</span>
        </div>
   <!-- Card: QR Code -->
  ...
  function goToBrowser() { router.push('/browser') }
   ...
   function goToVoiceRoom() { router.push('/VoiceRoomTest') }
  </script>
