    ...
    <ion-header :translucent="true" collapse="fade">
      <ion-toolbar class="liquid-toolbar">
        <ion-buttons slot="start">
          <div @click="router.go(-1)" color="dark">
        ...
        <ion-buttons slot="end">
          <div @click="goToSettings">
            <ion-icon style="font-size:20px;margin-right:10px;" color="dark" :icon="createOutline"/>
          </div>
        </ion-buttons>
      </ion-toolbar>
    </ion-header>
...
import { copyOutline, createOutline,chevronBackOutline } from 'ionicons/icons';
